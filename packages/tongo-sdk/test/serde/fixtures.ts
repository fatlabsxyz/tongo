...
export type TransferOptions = AbiType<TongoAbi, "tongo::structs::operations::transfer::TransferOptions">;
export type WithdrawOptions = AbiType<TongoAbi, "tongo::structs::operations::withdraw::WithdrawOptions">;
export type RagequitOptions = AbiType<TongoAbi, "tongo::structs::operations::ragequit::RagequitOptions">;
...
// balance: 0
const aEHint = {
  ciphertext: 0x73db44739c216a4648e3d4921bbdcfbed555e6aef3210cdeb5f3346ea4106f3e6465a0d32de75e1fb1a68dbab9afd86d9df276821692b5c92b9fc1e87faeb46bn,
