...
use she::protocols::{
    range::{RangeInputs, RangeProof},
    bit::BitProofWithPrefix,
};
use crate::{
    structs::common::starkpoint::StarkPoint,
    verifier::utils::generator_h,
};
...
pub impl ConvertRangeProofImpl of ConvertRangeProof {
    ...
    fn to_she_proof(self: Range, bit_size:u32, initial_prefix: felt252) -> (RangeInputs, RangeProof) {
        ...
        let she_inputs = RangeInputs{
            g1,
            g2,
            bit_size:she_commitments.len(),
            commitments:she_commitments.span()
        };
