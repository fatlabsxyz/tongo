...
use she::protocols::{
    range::verify as range_verify,
    SameEncryption::{
        SameEncryptionInputs,
        SameEncryptionProof,
        verify as same_encrypt_verify,
    },
...
use crate::{
    structs::{
        ...
        operations::transfer::{InputsTransfer, ProofOfTransfer},
    },
    verifier::{
        utils::{verifyOwnership, generator_h},
        range::ConvertRangeProofImpl
    }
};
...
pub fn verify_transfer(inputs: InputsTransfer, proof: ProofOfTransfer) {
    ...
    same_encrypt_unknown_random_verify(
        same_encrypt_inputs, 
        same_encrypt_proof,
