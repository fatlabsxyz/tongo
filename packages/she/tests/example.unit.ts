...
describe("Example test suit", () => {
  ...
  it("Testing coincidence with cairo generate_random", () => {
    ...
    expect(random).toEqual(
      2741632516191195515102142298096746973862893083064783049698513984956207988403n,
    );
  });
  ...
  it("Testing prove_fund vs cairo", () => {
    ...
    const s = proof.sx;
    expect(Ax).toEqual(
      3612455079586708671597307320927915563177263408831939025216409148308051669345n,
    );
    expect(Ay).toEqual(
      155702499075322517658393597207157113803433518217659499099352953264649181897n,
    );
    expect(s).toEqual(
      1107716913810057927411929679130300674893211025343893263845808350282517648805n,
    );
  });
